...
grant select on rrhh.especialidad to 'usuariolector'@'localhost' ;
grant select on rrhh.horarios to 'usuariolector'@'localhost' ;
grant select on rrhh.medicos to 'usuariolector'@'localhost' ;
...
grant select on rrhh.vacaciones to 'usuariolector'@'localhost' ;
...
grant select, insert, update on rrhh.especialidad to 'usuario2'@'localhost';
grant select, insert, update on rrhh.establecimiento to 'usuario2'@'localhost';
grant select, insert, update on rrhh.horarios to 'usuario2'@'localhost';
grant select, insert, update on rrhh.medicos to 'usuario2'@'localhost';
...
grant select, insert, update on rrhh.vacaciones to 'usuario2'@'localhost';
