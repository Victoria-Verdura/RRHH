...
DELIMITER $$
USE `rrhh`$$
CREATE PROCEDURE `insertar_personas`( nr_dni INT, dt_nacimiento date, nm_apellido text, nm_nombre text, nm_seg_nombre text, nr_telefono int,  ie_empleado tinyint(1))
BEGIN
...
values ( nr_dni, nm_nombre, nm_seg_nombre, nm_apellido, dt_nacimiento, null, nr_telefono, null, null, null, null, ie_empleado, null);
commit;
END$$
